...
const POST_SELECT = `
  id, slug, type, title, caption, excerpt, published_at, project_meta, content_meta, facebook_share_enabled,
...
export async function getSiteSettings() {
  ...
  return data || {
    ...
    intro: 'Posts, photos, writings, projects, books, and whatever I am working on.', bio: 'Creator sharing work, ideas, updates, and stories in one place.',
